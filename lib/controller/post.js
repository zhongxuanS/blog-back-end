...
exports.getPostDetail = async (req, res) => {
  try {
    ...
    Assert.assertHasParameter(params, 'year', ERROR_CODE.PA_NO_YEAR);
    Assert.assertHasParameter(params, 'month', ERROR_CODE.PA_NO_MONTH);
    Assert.assertHasParameter(params, 'day', ERROR_CODE.PA_NO_DAY);
    Assert.assertHasParameter(params, 'title', ERROR_CODE.PA_NO_TITLE);
